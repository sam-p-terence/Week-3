...
//     return axios.get("http://localhost:3000/repeat/'hello-there-the-angel-from-my-nightmare")
//     .then(res => res.data)
// }
...
axios.get('http://localhost:3000/repeat/hello-there-the-angel-from-my-nightmare')
    .then (res => {
       console.log(res.data)
    })
}
...
const queryButton = () => {
    axios.get('http://localhost:3000/hello-is-there-anybody-out-there?myQueryExample=Trogdor')
    .then(res => {
        console.log(res.data)
    })
}

document.querySelector('#query-button').addEventListener('click', queryButton)
